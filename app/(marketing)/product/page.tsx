          ...
          <Container asGrid>
            <div className="grid grid-cols-10 gap-px bg-border">
              ...
              <div className="col-span-full sm:col-span-8">
                <div data-grid-content className="px-6 pb-16 pt-12 text-center">
                  <div className="relative mx-auto max-w-3xl text-center">
                    ...
                    <p className="text-muted-foreground mx-auto mb-8 mt-6 text-balance text-lg">
                      Our Enterprise Invoicing solution simplifies billing
                      processes, enhances financial oversight, and ensures
                    ...
                    <div className="flex gap-2 items center justify-center">
                      ...
                      >
                        <Link href="#">Browse Features</Link>
                      </Button>
                      <Button
                        asChild
                        size="lg"
                        className="text-sm shadow-xl shadow-indigo-900/40"
                      >
                        <Link href="/sign-in">Start your inventory</Link>
                      </Button>
                    </div>
